...
#       Newton Monteiro, Wallace Silva, Felipe Martenexen, Vera Laísa
...
SOURCES = \
	__init__.py \
	MapBiomas_fogo.py MapBiomas_fogo_dialog.py

PLUGINNAME = MapBiomas_fogo

PY_FILES = \
	__init__.py \
	MapBiomas_fogo.py MapBiomas_fogo_dialog.py

UI_FILES = MapBiomas_fogo_dialog_base.ui
...
QGISDIR=C:\Users\Newton Monteiro\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
